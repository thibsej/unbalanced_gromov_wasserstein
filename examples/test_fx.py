...
a, Cx, _ = generate_measure(n_batch=1, n_sample=3, n_dim=3)
b, Cy, _ = generate_measure(n_batch=1, n_sample=3, n_dim=2)
...
cost_pi = solv.ugw_cost(pi, pi, a, Cx, b, Cy)
cost_gamma = solv.ugw_cost(gamma, gamma, a, Cx, b, Cy)
cost_gamma = solv.l2_distortion(gamma, gamma, Cx, Cy)
